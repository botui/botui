...
const config = {
  title: 'BotUI',
  tagline: 'Build customizable conversational UIs',
  url: 'https://docs.botui.org',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        links: [
          {
            ...
            items: [
              ...
              {
                label: 'Twitter',
                href: 'https://twitter.com/moinism',
              },
            ],
          },
          {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Moin Uddin. Built with Docusaurus.`,
      },
      prism: {
